  ...
  <link rel="icon" type="image/png" sizes="48x48" href="/manager/img/favicons/favicon-48x48.png">
  ...
  <link rel="mask-icon" href="/manager/img/favicons/safari-pinned-tab.svg" color="#0048a5">
